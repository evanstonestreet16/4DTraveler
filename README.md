...
Desktop browsers are the only supported target. Mobile/tablet design, optimization, asset generation and testing are out of scope; see [contributor scope](AGENTS.md).
