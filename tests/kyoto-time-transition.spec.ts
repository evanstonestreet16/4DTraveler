...
for (const viewport of [
  ...
  test(`Kyoto time travel and historical exploration at ${viewport.width}px`, async ({
    page,
  }, testInfo) => {
...
test('direct Present entry supports reduced motion and responsive return travel', async ({
  page,
}) => {
